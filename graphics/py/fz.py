...
mc = XY(rnd(-1, 1), rnd(-1, 1))
jc = XY(rnd(-1, 1), rnd(-1, 1))
stderr.write("localize mandelbrot target coordinate\n")
#m = FractalMovie(MandelFrame(r, mc, 2, 16), 47)
m = FractalMovie(MandelFrame(r, mc, 2, 128), 47)
m.generate(16)
stderr.write("use mandelbrot target as julia-constant\n")
#m = FractalMovie(JuliaFrame(m.f.a, r, jc, 2, 16), 47)
m = FractalMovie(JuliaFrame(m.f.a, r, jc, 2, 128), 47)
m.generate(16)
